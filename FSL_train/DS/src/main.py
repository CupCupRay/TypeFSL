...
def parse_args():
    ...
    parser.add_argument("--dataset", type=str, default="asm_x86-64_O0",
                        help="name of the dataset. ")
    parser.add_argument("--dataset_type", type=str, default="inter",
                        help="type of the dataset. "
                        "Options: [agg, normal, inter]")                
...
def main():
    ...
    if args.mode == "train" or args.mode == "filter":
    ...
    if args.mode != "finetune":
        val_acc, val_std = train_utils.test(val_data, model, args, args.val_episodes)
    else:
        val_acc, val_std = 0, 0

    test_acc, test_std = train_utils.test(test_data, model, args, args.test_episodes, vocab)
