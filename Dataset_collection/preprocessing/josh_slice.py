...
def build_graph(instruction: binaryninja.MediumLevelILInstruction, squash_loops=False):
...
def var_graph_to_insn_graph(g):
    ...
    for start, end in g.edges():
        if start in mapping and end in mapping and mapping[start] != mapping[end]:
